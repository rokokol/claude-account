...
- [Как устроено переключение](#как-устроено-переключение)
- [Что по умолчанию своё у аккаунта, а что общее](#что-по-умолчанию-своё-у-аккаунта-а-что-общее)
- [Команды](#команды)
- [Установка](#установка)
  - [Home Manager](#home-manager)
  - [Зачем прибивать CLAUDE_CONFIG_DIR](#зачем-прибивать-claude_config_dir)
